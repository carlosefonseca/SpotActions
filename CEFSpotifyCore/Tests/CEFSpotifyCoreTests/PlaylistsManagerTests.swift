...
class PlaylistsManagerTests: XCTestCase {
    ...
    let artist1 = ArtistJSON(external_urls: nil, href: nil, id: "artist1", name: "Artist 1", type: nil, uri: nil)
    let artist2 = ArtistJSON(external_urls: nil, href: nil, id: "artist2", name: "Artist 2", type: nil, uri: nil)
    let artist3 = ArtistJSON(external_urls: nil, href: nil, id: "artist3", name: "Artist 3", type: nil, uri: nil)
    let artist4 = ArtistJSON(external_urls: nil, href: nil, id: "artist4", name: "Artist 4", type: nil, uri: nil)
    ...
    func test_fetch_single_page_of_tracks() {
        ...
        let singlePage = PagedTracksJSON(href: nil, items: [track1, track2, track3, track4], limit: 4, next: nil, offset: 0, previous: nil, total: 4)
    ...
    func test_fetch_multiple_pages_of_tracks() {
        ...
        let page1 = PagedTracksJSON(href: nil, items: [track1], limit: 1, next: "offset1", offset: 0, previous: nil, total: 4)
        let page2 = PagedTracksJSON(href: nil, items: [track2], limit: 1, next: "offset2", offset: 1, previous: nil, total: 4)
        let page3 = PagedTracksJSON(href: nil, items: [track3], limit: 1, next: "offset3", offset: 2, previous: nil, total: 4)
        let page4 = PagedTracksJSON(href: nil, items: [track4], limit: 1, next: nil, offset: 3, previous: nil, total: 4)
